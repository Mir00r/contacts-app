jQuery(document).ready(function () {
    ...
    jQuery('.card-body').on('click', '.add-new-number ', function () {
        ...
        CONTACTS.ajax.call({
            url: CONTACTS.baseURL + "contactDetails/create",
            dataType: "html",
                ...
                confirm: {
                    ...
                    action: function () {
                        if (contactId !== undefined) {
                            CONTACTS.ajax.call({
                                url: CONTACTS.baseURL + "contactDetails/delete/" + contactId,
                                success: function (content) {
                                    if (content.success === true) {
                                        CONTACTS.messageBox.showMessage(true, content.info);
                                        _this.closest(".form-group").remove();
                                    } else {
                                        CONTACTS.messageBox.showMessage(false, content.info)
                                    }
                                }
                            });
                        } else {
