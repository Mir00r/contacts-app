            ...
            <div class="btn-group">
                <g:form controller="contact" action="index" method="GET">
                    <div class="input-group" id="search-area">
                        <g:select name="colName" class="form-control" from="[name: 'Name']" value="${params?.colName}"
                ...
                <tr>
                    <td>
                        <g:if test="${info.image}">
                            <img src="${resource(dir: "contact-image", file: "/${info.id}-${info.image}")}"
                                 class="img-thumbnail" style="height: 50px; width: 50px;"/>
                        </g:if>
                        <g:else>
                            <g:img dir="images" file="grails.svg" class="img-thumbnail"
                    ...
                    <td>
                        <div class="btn-group">
                            <g:link controller="contact" action="details" class="btn btn-secondary" id="${info.id}"><i
                                    class="fas fa-eye"></i></g:link>
                            <g:link controller="contact" action="edit" class="btn btn-secondary" id="${info.id}"><i
                                    class="fas fa-edit"></i></g:link>
                            <g:link controller="contact" action="delete" id="${info.id}"
